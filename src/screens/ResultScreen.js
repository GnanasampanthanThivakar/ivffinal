...
const SuccessRing = ({ percentage = 68 }) => {
  ...
  // We want a 270 degree arc for example, or open bottom. Let's do a full circle for simplicity or open at bottom.
  // The design shows a mostly complete circle with a gap at bottom layout.
  // Let's approximate with a standard circle for now.
    ...
    <View style={styles.journeyStep}>
        <View style={styles.journeyLeft}>
            <View style={[styles.journeyIconCircle, { backgroundColor: theme.colors.primary }]}>
                {/* Use a simple checkmark or icon if available */}
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.resultCard}>
            ...
            <View style={styles.factorsContainer}>
                 <FactorBar label="Age" value="80%" color="#80CBC4" />
                 <FactorBar label="AMH" value="65%" color="#FFAB91" />
                 <FactorBar label="BMI" value="70%" color="#CE93D8" />
                 <FactorBar label="Lifestyle" value="90%" color="#80CBC4" />
            </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  headerPanel: {
    ...
    paddingBottom: 60, // Space for the card to overlap
    paddingHorizontal: theme.spacing.l,
    borderBottomLeftRadius: 30, 
    borderBottomRightRadius: 30,
    marginBottom: -40, // Pull the card up
    zIndex: 0,
